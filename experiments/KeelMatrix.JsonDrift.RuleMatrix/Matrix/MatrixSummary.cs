...
{
    /// <summary>Number of checks this class contributes to the matrix.</summary>
    public const int SummaryCheckCount = 3;

    /// <summary>Executed checks in the matrix, asserted by <c>D04.matrix.check-count</c>.</summary>
    public const int ExpectedCheckCount = 165;
    ...
    public const int ExpectedUnsupportedCount = 22;
