...
| `extension-data + polymorphism` | `Cannot interact` | `recognized discriminator keys are consumed by polymorphic dispatch rather than treated as unmatched extension data; derived extension-data members are compared recursively` | `Not applicable` |
