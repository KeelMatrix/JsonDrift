...
| `polymorphic reader materialization` | `RecordedNode.PolymorphismRequiresTypeDiscriminator` | `R10d.polymorphism.discriminator-required` | `test:ConcreteToAbstractPolymorphicTransitionRequiresADiscriminator` | `Unsupported` | `Not applicable` |
